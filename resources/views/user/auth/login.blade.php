            ...
            <div class="row">
                <div class="col-lg-5 col-md-8 col-sm-10 mx-auto">
                    <div class="cuatomer_signup_form_wraper">
                        ...
                        <form action="{{ route('user.login')}}" name="loginForm" method="post" id="loginForm" class="pt-5">
                            @csrf
                            <div class="col-12 mb-3 signup_input_wraper">
                                <input type="email" class="form-control" id="inputEmail"  name="email" value="{{ old('email') }}" placeholder="{{__('msg.Email')}} ({{__('msg.Required')}})" required>
                                @error('email')
