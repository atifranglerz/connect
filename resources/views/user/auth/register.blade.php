                ...
                <div class="col-lg-6 col-md-8 col-sm-8 mx-auto">
                    <div class="cuatomer_signup_form_wraper mt-5 mt-lg-5 ">
                        ...
                        <form  method="post" action="{{route('user.register')}}" class="pt-5">
                            ...
                            <div class="col-12 mb-3 signup_input_wraper">
                                <input type="text" class="form-control" name="phone" id="inputNumber" placeholder="Mobile Number">
                            </div>
                            <div class="col-12 mb-3 signup_input_wraper">
                            ...
                            <div class="col-12 mb-3 signup_input_wraper">
                                <input type="text" class="form-control"  name="post_box" id="inputNumber" placeholder="P/O Box">
                            </div>
                            <div class="col-12 mb-3 signup_input_wraper">
