                                    ...
                                    <div class="row g-lg-3 g-2">
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            <input type="text" class="form-control" name="model"
                                                value="{{old('model')}}" placeholder="Model" aria-label="Car Milage">
                                            @error('model')
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            <input type="text" class="form-control" name="color"
                                                value="{{old('color')}}" placeholder="Color" aria-label="Car Milage">
                                            @error('color')
                                            <div class="text-danger p-2">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="row g-lg-3 g-2">
                                        ...
                                        <div class="col-lg-6 col-md-12 get-quotes-block">
                                            <div class="d-grid gap-2 mt-lg-3 mb-lg-4">
                                                <button class="btn btn-secondary block get_appointment" name="action"
                                                    value="all_garage" type="submit">GET QUOTES FROM ALL
                                                    GARAGES</button>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-12 get-quotes-block">
                                            <div class="d-grid gap-2 mt-lg-3 mb-4">
                                                <button
                                                    ...
                                                    name="action" value="preferred_garage" type="submit">GET QUOTES FROM
                                                    PREFFERED GARAGES</button>
                                            </div>
                                        </div>
                                        <div class="col-12 d-none" id="requestForInspection">
                                            <div align="center" class="mt-3">
                                                <button
                                                    class="btn text-center btn-primary get_quot block get_appointment"
                                                    name="action" value="all_garage" type="submit">SEND REQUEST FOR
                                                    INSPECTION</button>
                                            </div>
                                        </div>
                                    </div>
