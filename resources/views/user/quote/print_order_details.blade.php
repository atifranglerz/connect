            ...
            <div class="col-lg-10 mx-auto">
                <div class="main_content_wraper dashboard mt-1 mt-lg-5 mt-md-5 white-background-box">
                    <h5 class="sec_main_heading text-center">{{$data->vendordetail->garage_name}} {{__('msg.GARAGE')}}</h4>
                        ...
                        <p class="sec_main_para text-center"><b><b>{{__('msg.Tel')}}  : </b><span>{{$data->vendordetail->phone}}</span>,
                            <b>{{__('msg.Fax')}} : </b><span>3881433</span>
                        </p>
                                ...
                                <h6 class="mt-3">{{__('msg.Spares Details')}}h4>
                                    ...
                                    <h6 class="mt-3">Others :</h4>
                                        ...
                                        <div>
                                            ...
                                            <a class="btn-secondary get_appointment mt-3" href="#" id="pdf">{{__('msg.Download Pdf')}}
                                                </a>
                                        </div>
