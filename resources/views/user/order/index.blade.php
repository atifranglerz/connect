                    ...
                    <div class="all_quote_card ">
                        ...
                        <div class=" w-100  quote_detail_wraper">
                            <div class="quote_info">
                                <h3 class="d-flex align-items-center active_quote">Car Repair
                                </h3>
                        ...
                        <div class=" w-100  quote_detail_wraper">
                            ...
                            <div class="quote_detail_btn_wraper">
                                ...
                                <div class="d-flex align-items-center chat_view__detail">
                                    <a href="#" class="chat_icon">
                                        <i class="fa-solid fa-message"></i>
                                        <!-- <img src="'public/vendorassets/images/meassageiconblk.svg"> -->
                                    </a>
                                    <a href="pendingOrderDetail.php" class="btn-secondary">VIEW DETAILS</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-11 col-md-12  mx-auto">
                    <div class="all_quote_card ">
                        ...
                        <div class=" w-100  quote_detail_wraper">
                            ...
                            <div class="quote_detail_btn_wraper">
                                <div class="quote_detail_btn_wraper">
                                    <h3 class=" text-sm-center vendor_replies_dtl allOrder">Canceled</h3>
                                </div>
                                <h3 class=" text-sm-center">AED 1200</h3>
                                <div class="d-flex align-items-center chat_view__detail">
                                    <a href="#" class="chat_icon">
