            ...
            <div class="row">
                <div class="col-lg-10 mx-auto">
                    <div class="main_content_wraper dashboard mt-1 mt-lg-5 mt-md-5 white-background-box">
                        <h5 class="sec_main_heading text-center">{{ $data->vendordetail->garage_name }}
                            {{ __('msg.GARAGE') }}</h5>
                        <p class="sec_main_para text-center">{{ $data->vendordetail->address }}{{ __('msg.P/O Box') }}
                            {{ $data->vendordetail->post_box }}</p>
                        <p class="sec_main_para text-center"><b><b>{{ __('msg.Tel') }}:
                                </b><span>{{ $data->vendordetail->phone }}</span>
                        </p>
                        <p class="text-center"><b>{{ __('msg.Email') }}:
                            </b>{{ $data->vendordetail->vendor->email }}</p>
                        ...
                        <div>
                            ...
                            <div style="display:flex;width: 600px;margin:auto;">
                                ...
                                <a href="{{ route('user.reject-resolution', $data->id) }}"
                                    class="btn text-center px-5 btn-primary get_quot block get_appointment d-flex align-items-center justify-content-center mt-3">{{__('msg.REJECT RESOLUTION')}}</a>
                                <a class="btn-secondary get_appointment mt-3" href="#" id="pdf">{{ __('msg.Download Pdf') }}</a>
                                <a href="{{ route('user.accept-resolution', $data->id) }}"
                                    class="btn text-center px-5 btn-primary get_quot block get_appointment d-flex align-items-center justify-content-center mt-3">{{__('msg.ACCEPT RESOLUTION')}}</a>
                            </div>
                        </div>
