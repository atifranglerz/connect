<div id="dashboardSidebar">
    ...
    <div class="sidebar_navigation">
        <ul class="sidebar_navcigation">
            ...
            <li><a href="{{ route('user.archive') }}"><img src="{{ asset('public/user/assets/images/dashpaymenticon.svg') }}"><span>Archived</span></a></li>
            ...
            <li><a href="{{route('user.term_condition')}}"><img src="{{ asset('public/user/assets/images/dashpaymenticon.svg') }}"><span>Terms & Conditions (Agreed)</span></a></li>
        </ul>
    </div>
