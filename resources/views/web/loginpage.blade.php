                ...
                <div class="row g-4">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="card">
                            ...
                            <div class="card-body text-center">
                                <p class="card-text text-center sing_up_card_txt">Get list of Insurance company providing their insurancd service, register your company and grow business.
                                </p>
                                <a href="{{route('company.login')}}" class="btn btn-secondary Signup_btn">Company</a>
                            </div>
                        </div>
                    </div>
                </div>
