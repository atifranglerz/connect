                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="card">
                            ...
                            <div class="card-body text-center">
                                ...
                                <a href="{{route('vendor.login')}}" class="btn btn-secondary Signup_btn">{{__('msg.Vendor')}}</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="card">
                            ...
                            <div class="card-body text-center">
                                ...
                                <a href="{{route('user.login')}}" class="btn btn-secondary Signup_btn">{{__('msg.Customer')}}</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="card">
                            ...
                            <div class="card-body text-center">
                                ...
                                <a href="{{route('user.companyLogin')}}" class="btn btn-secondary Signup_btn">{{__('msg.Insurance Company')}}</a>
                            </div>
                        </div>
                    </div>
                </div>
