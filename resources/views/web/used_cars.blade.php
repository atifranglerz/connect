                            ...
                            <form  action="{{url('search-used-car')}}"  method="post" id="submitform" class="my-2">
                                ...
                                <div class="row" >
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        ...
                                        <input type="text" name="priceFrom" class="form-control" placeholder="From" aria-label="Model">
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-6 mt-sm-0 mt-2">
                                        <div class="col-12 mb-2 signup_vendor ">
                                            <h6 class="mb-0 heading">Price</h6>
                                        </div>
                                        <input type="text" name="priceTo" class="form-control" placeholder="To" aria-label="Model">
                                    </div>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 mt-2">
                                        ...
                                        <select class="form-select form-control model-year-field" name="modelFrom" aria-label="Type of Service" >
                                            <option value=""></option>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 mt-2">
                                        ...
                                        <select class="form-select form-control model-year-field" name="modelTo" aria-label="Type of Service" >
                                            <option value=""></option>
                                            @foreach($year as $data)
                                                <option value="{{$data->model_year }}" >{{$data->model_year }}</option>
                                            @endforeach
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 mt-2">
                                        ...
                                        <input type="text" name="milage" class="form-control" placeholder="Milage e.g 40 Km" aria-label="Model">
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-6 mt-2">
                                        <div class="col-12 mb-2 signup_vendor ">
