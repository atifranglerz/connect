                    ...
                    <div class="footer_link">
                        ...
                        <ul class="text-capitalize">
                            ...
                            <li><a href="{{ route('cookies') }}"><span class="fa fa-lock"
                                style="margin-right: 8px"></span>{{__('msg.Cookies Policy')}}</a></li>
                        </ul>
                    </div>
                </div>
