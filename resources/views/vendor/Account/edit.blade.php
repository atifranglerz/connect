                ...
                <div class="col-xl-6 col-lg-6 col-md-9 mx-auto">
                    <div class="cuatomer_signup_form_wraper mt-5">
                        <div class="main_content_wraper">
                            ...
                            <p class="sec_main_para text-center mb-0">Update Your Finance Detail</p>
                        </div>
                        <form action="{{ route('vendor.acount.update') }}" method="POST" enctype="multipart/form-data"
                            ...
                            <div class="col-12 mb-3  signup_input_wraper">
                                <input type="text" name="name" value="{{$account->owner_name}}" class="form-control" id="inputName"
                            ...
                            <div class="col-12 mb-3  signup_input_wraper">
                                <input type="text" name="bank_name" value="{{$account->bank_name}}" class="form-control" id="inputName"
                            ...
                            <div class="col-12 mb-3  signup_input_wraper">
                                <input type="number" name="iban" value="{{$account->iban}}" class="form-control" id="inputName"
                                    placeholder="IBAN">
                                @error('iban')
                                    <div class="text-danger p-2">{{ $message }}</div>
                                @enderror
