                        ...
                        @foreach ($attachment as $data)
                            ...
                            @if ($file[1] == 'jpg' || $file[1] == 'png' || $file[1] == 'svg')
                                <div class="mb-3 col-md-3 position-relative item">
                                    <p class="sender-name">Sended By: {{ $data->sender_name }}</p>
                                    <div class="d-flex justify-content-center align-items-center w-100 carAd_img_wraper doc_img customer_dashboard">
