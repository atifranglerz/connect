        ...
        <div class="container-lg container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link " href="{{ route('vendor.ads.index') }}">{{__('msg.My Ads Listing')}}</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link " href="{{url('vendor/my-bids')}}">{{__('msg.My Bids')}}</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link " href="{{ route('vendor.orders') }}">{{__('msg.Orders')}}</a>
                    </li>
                </ul>
                         ...
                         <a href="#" class="notify-btn"><i class="fa-solid fa-bell"></i><span id="notfication"
                            ...
                            <div class="notification_tooltip " id="notification_tolltip">
                                <ul class="notification_list shadow">
                                    ...
                                    <li><a href="{{ $data->links }}" class="notification" title="{{$data->title}}" id="{{$data->id}}">{{$data->title}}</a> <a href="#" class="notification" id="{{$data->id}}"><i class="bi bi-plus"></i></a>
                                    </li>
                                    @endforeach
                                </ul>
                            </div>
