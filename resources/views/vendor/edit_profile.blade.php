            ...
            <div class="col-xl-6 col-lg-6 col-md-9 mx-auto">
                <div class="cuatomer_signup_form_wraper mt-5">
                    ...
                    <form  action="" method="post" class="pt-5">
                        ...
                        <div class="col-12 mb-3  signup_input_wraper">
                            <input type="text" name="name" class="form-control" id="inputName" placeholder="Owner Name">
                        </div>
                        <div class="col-12 mb-3 signup_input_wraper">
                        ...
                        <div class="col-12 mb-3 signup_input_wraper">
                            <input type="text" name="postbox" class="form-control" id="inputNumber" placeholder="P/O Box">
                        </div>
                        <div class="col-12 mb-3 signup_input_wraper">
                            <input type="text" name="number" class="form-control" id="inputNumber" placeholder="Telephone No.">
                        </div>
                        <div class="col-12 mb-3  signup_input_wraper">
