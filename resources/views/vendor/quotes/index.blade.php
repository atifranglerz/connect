                            ...
                            <div class=" w-100  quote_detail_wraper">
                                ...
                                <div class="quote_detail_btn_wraper">
                                    ...
                                    <div class="d-flex align-items-center chat_view__detail">
                                        <a type="button" href="{{ url('vendor/chat/' . $value->user_id) }}" class="chat_icon"><i class="fa-solid fa-message"></i>
                                        </a>
                                        <?php
                                        $id = $value->userbid->id;
                                        ...
                                        ?>
                                        @if ($offer == null)
                                            <a href="{{ route('vendor.quotedetail', $value->userbid->id) }}" class="btn-secondary">{{ __('msg.view_details') }}</a>
                                        @else
                                            <a href="{{ route('vendor.view-offer', $value->userbid->id) }}" class="btn-secondary">{{ __('msg.View offer') }}</a>
                                        @endif
                                    </div>
                                </div>
                            </div>
