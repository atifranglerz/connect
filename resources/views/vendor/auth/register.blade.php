            ...
            <div class="row">
                <div class="col-lg-5 col-md-8 col-sm-10 mx-auto">
                    <div class="cuatomer_signup_form_wraper mt-5 mt-lg-5 ">
                        ...
                        <form name="signUpForm" action="{{route('vendor.register')}}"  enctype="multipart/form-data" method="post" class="pt-5">
                            @csrf
                            ...
                            <div class="col-12 mb-3 signup_input_wraper">
                                <input type="text" name="garage_name" class="form-control" value="{{old('garage_name')}}" id="inputgarageName" placeholder="{{__('msg.Garage Legal Name')}} ({{__('msg.Required')}})" required>
                                @error('garage_name')
                                <div class="text-danger p-2">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-12 mb-3 signup_input_wraper">
                                <input type="email" name="email" value="{{ old('email') }}" class="form-control" id="inputEmail" placeholder="{{__('msg.Email')}} ({{__('msg.Required')}})" required>
                                @error('email')
                                <div class="text-danger p-2">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-12 mb-3 signup_input_wraper">
                                <select class="form-select form-control insurance-company insurance-company-multiple" name="company[]" aria-label="company" multiple="multiple">
                            ...
                            <div class="col-12 mb-3 signup_input_wraper">
                                <input type="number" name="post_box" value="{{ old('post_box') }}" class="form-control" placeholder="{{__('msg.P/O Box')}} ({{__('msg.Required')}})" required>
                                @error('post_box')
                                <div class="text-danger p-2">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-12 mb-3 signup_input_wraper">
                                <input type="text" name="trading_license" value="{{ old('trading_license') }}" class="form-control"  placeholder="{{__('msg.Trading License No.')}} ({{__('msg.Required')}})" required>
                                @error('trading_license')
                                <div class="text-danger p-2">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-12 mb-3 signup_input_wraper">
                                <input type="text" name="vat" value="{{ $vat->percentage}}% VAT" class="form-control"  placeholder="{{__('msg.VAT Details')}} ({{__('msg.Required')}})" readonly>
                                @error('vat')
                                <div class="text-danger p-2">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-12 mb-3 signup_input_wraper">
                                <div style="position: relative">
                                    <input type="text" name="billing_address" value="{{ old('billing_address') }}" class="form-control address-field" placeholder="{{__('msg.Address')}} ({{__('msg.Required')}})" required style="padding-right: 2rem">
                            ...
                            <div class="col-12 mb-3 signup_input_wraper">
                                <input type="text" name="appointment_number" value="{{ old('appointment_number') }}" class="form-control" placeholder="+971 XXXXXXXX ({{__('msg.Required')}})" required>
                            ...
                            <div class="col-12 mb-3 signup_input_wraper">
                                <div class="position-relative d-flex align-items-center pass-holder">
                                    <input id="inputPass" name="password" type="password" value="{{ old('password') }}" class="form-control pass-input" placeholder="{{__('msg.password')}} ({{__('msg.Required')}})" autocomplete="off">
                            ...
                            <div class="col-12 mb-3 signup_input_wraper">
                                <div class="position-relative d-flex align-items-center pass-holder">
                                    <input id="inputConPass" name="conform_password" value="{{old('conform_password')}}" type="password" class="form-control pass-confirm-input" placeholder="{{__('msg.Confirm Password')}} ({{__('msg.Required')}})">
