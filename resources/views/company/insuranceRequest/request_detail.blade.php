            ...
            <div class="row">
                <div class="col-lg-10 mx-auto">
                    <div class="main_content_wraper dashboard mt-1 mt-lg-5 mt-md-3">
                        <h4 class="sec_main_heading text-center mb-0">Car Detail</h4>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="all_quote_card  vendor_rply_dtlL _text">
                        ...
                        <div class="owl-carousel carousel_se_03_carousel owl-theme mt-3">
                            ...
                            @elseif($car_images && count($car_images) == 1)
                            ...
                            @elseif($car_images && count($car_images) == 2)
                                @foreach ($car_images as $image)
                                    <div class="item">
                                        <div class="carAd_img_wraper doc_img customer_dashboard">
                                            <img src="{{ asset($image) }}">
                                        ...
                                        <div class="row mt-5 mb-4 g-3">
                                            <div class="col-lg-6 col-md-6 col-sm-6">
                                                <div class="d-grid gap-2 mt-lg-3 ">
                                                    <a target="_blank"href="{{ url('company/print-order-details', $data->id) }}"
                                            ...
                                            <div class="col-lg-6  col-md-6 col-sm-6">
                                                <div class="d-grid gap-2 mt-lg-3 ">
                                                    <a href="{{ route('company.pay-payment', $data->id) }}"
                                                        class="btn text-center btn-primary get_quot block get_appointment d-flex justify-content-center align-items-center"
                                                        type="button">PAY INSURANCE PAYMENT
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="col-lg-8 col-md-10 col-sm-8  mx-auto">
                                <div class="row mt-1 g-3">
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        <div class="d-grid gap-2 ">
                                            <button class="btn text-center btn-primary get_quot block get_appointment"
                                                type="button">Car Model : {{ $userbid->model }}</button>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        <div class="d-grid gap-2">
                                            <button class="btn text-center btn-primary get_quot block get_appointment"
                                                type="button">Car Make : {{ $company->company }}</button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        <div class="d-grid gap-2 ">
                                            <button class="btn text-center btn-primary get_quot block get_appointment"
                                                type="button">Customer Name : {{ $userbid->car_owner_name }}</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
