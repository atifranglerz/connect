...
<script src="assets/multi-select/dist/filter-multi-select-bundle.min.js"></script>
...
<script type="text/javascript">
  (function ($) {
      ...
      $('.notification_tooltip').toggle();
          ...
          $(".input-images-8>.image-uploader>.upload-text").append('<label class="img_wraper_label"><div class="file_icon_wraper"><img src="assets/images/fileuploadicon.svg"></div><p class="mb-0">Upload Your Picture </p><input type="file" size="60" ></label> ');
          $('.input-images-9').imageUploader();
          $(".input-images-9>.image-uploader>.upload-text").append('<label class="img_wraper_label"><div class="file_icon_wraper"><img src="assets/images/fileuploadicon.svg"></div><p class="mb-0">Upload Your ID</p><input type="file" size="60" ></label> ');
          $('.input-images-10').imageUploader();
          $(".input-images-10>.image-uploader>.upload-text").append('<label class="img_wraper_label"><div class="file_icon_wraper"><img src="assets/images/fileuploadicon.svg"></div><p class="mb-0">Upload Your Trade License and ID </p><input type="file" size="60" ></label>');
