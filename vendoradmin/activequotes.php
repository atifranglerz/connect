    ...
    <div class="row">
      <div class="col-lg-10 mx-auto">
        <div class="main_content_wraper dashboard mt-1 mt-lg-5 mt-md-5">
          ...
          <p class="sec_main_para text-center">See what are the active quotes near you</p>
        </div>
      </div>
    </div>
        ...
        <div class="all_quote_card ">
          ...
          <div class=" w-100  quote_detail_wraper">
            ...
            <div class="quote_detail_btn_wraper">
              <h3 class=" text-sm-center">#12345678</h3>
              <div class="d-flex align-items-center chat_view__detail">
               ...
               <a href="quoteRespons.php" class="btn-secondary">VIEW DETAILS</a>
             </div>
           </div>
         </div>
       </div>
