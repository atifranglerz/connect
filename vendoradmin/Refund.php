...
<section class="pb-5 login_content_wraper" style="background-image:url(assets/images/gradiantbg.jpg);">
  ...
  <div class="row  mt-5">
    <div class="col-lg-12">
      <div class="all_quote_card  vendor_rply_dtlL _text">
        <div class="over_view_part carad_data vendor_detail">
          <h3 class=" text-center mb-5">REFUND AMOUNT</h3>
          <p class="text-center">REFUND CUSTOMER IF THE WORK COST IS LOWER THAN THE TOTAL BUDET OF ORDER</p>
        </div>
        <div class="vendor__rply__dttl">
          <form>
 ...
 -->              <div class="col-lg-12">
                <div class="row g-lg-3 g-2">
                 <div class="col-lg-6 col-md-6 col-sm-6 ">
                  <input type="text" class="form-control" placeholder="Work Days To Be Excluded">
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6">
                  <input type="text" class="form-control" placeholder="Amount To Refund">
                </div>
                <div class="col-lg-12 col-md-12 mb-3">
                  <div class="form-floating">
                    ...
                    <label for="floatingTextarea2">Add Refund Details</label>
                  </div>
