    ...
    <div class="row">
      <div class="col-lg-10 mx-auto">
        <div class="main_content_wraper dashboard mt-1 mt-lg-5 mt-md-5">
          ...
          <p class="sec_main_para text-center">Select your preferred vendor w.r.t area or price</p>
        </div>
      </div>
    </div>

    <div class="row g-2">
      <div class="col-lg-10 col-md-12 col-10  mx-auto">
        <div class="all_quote_card ">
          ...
          <div class="  w-100  quote_detail_wraper align-items-md-center">
            <div class="quote_info Leavereview">
              <h3 class="d-flex align-items-center active_quote">Car Repair <span class="order_id">#12345678</span></h3>
