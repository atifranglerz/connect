...
<section class="pb-5 login_content_wraper" style="background-image:url(assets/images/gradiantbg.jpg);">
   ...
   <div class="row">
    <div class="col-lg-10 mx-auto">
      <div class="main_content_wraper dashboard mt-1 mt-lg-5 mt-md-5">
        <h1 class="sec_main_heading text-center mb-0"> CANCEL ORDER</h1>
  ...
  <div class="row  mt-5">
    <div class="col-lg-12">
      ...
      <div class="all_quote_card  vendor_rply_dtlL _text">
        <div class="over_view_part carad_data vendor_detail">
          <h3 class=" text-center mb-5">CANCELLATION REQUEST</h3>
        </div>
        <div class="vendor__rply__dttl">
          
            <h3 class="active_order_req cancle_order">Reason For Cancelling</h3>
   ...
   <div class="row">
    <div class="col-xl-7 col-lg-6 col-md-10 col-sm-10 mx-auto">
      <div class="row mt-3 mb-4 g-3">
        
        <div class="col-lg-6 col-md-6 col-sm-6">
          <div class="d-grid gap-2 mt-lg-3 ">
            <a href="#" class="btn btn-secondary block get_appointment" type="button">  CANCEL ORDER
            </a>
          </div>
        </div>
        <div class="col-lg-6 col-md-6 col-sm-6">
          <div class="d-grid gap-2 mt-lg-3 ">
            <a href="#" class="btn text-center btn-primary get_quot block get_appointment d-flex align-items-center justify-content-center" type="button">REJECT REQUEST
            </a>
          </div>
        </div>
      </div>
