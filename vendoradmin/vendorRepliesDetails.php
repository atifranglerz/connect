...
<section class="pb-5 login_content_wraper" style="background-image:url(assets/images/gradiantbg.jpg);">
  <div class="container" >
    <div class="row">
      <div class="col-xl-8 col-lg-7  col-md-10 mx-auto">
        <div class="row mt-5 mb-4 g-3">
          <div class="col-lg-6 col-md-6">
            <div class="d-grid gap-2 mt-lg-3 ">
              <a href="activequotes.php" class="btn text-center btn-primary get_quot block get_appointment d-flex justify-content-center align-items-center" type="button">GO BACK TO ALL QUOTES
              </a>
            </div>
          </div>
          <div class="col-lg-6 col-md-6">
