      ...
      <div class="col-lg-11 col-md-12 col-11  mx-auto">
        <div class="all_quote_card  vendor_rply_dtlL completed_orders">
          ...
          <div class=" w-100  quote_detail_wraper">
            ...
            <div class="quote_detail_btn_wraper d-flex align-items-lg-end align-items-md-end flex-column align-items-sm-center">
              <div class="quote_detail_btn_wraper">
                <h3 class="  text-sm-center vendor_replies_dtl allOrder text-md-end">Waiting For Review</h3>
              </div>
              <h3 class=" text-sm-center">AED 1200</h3>
              <div class="completed_order_id">
                <p class="text-center">Order ID:  <span>#12345678</span></p>
              </div>
            </div>
          </div>
        </div>
                ...
                <div class="row mt-1 g-3">
                  <div class="col-lg-12 col-md-8 mx-auto">
                    <div class="form-floating">
                      <textarea class="form-control" placeholder="Add Repairing Details" id="floatingTextarea2" style="height: 177px">
                      </textarea>
                    </div>
                  </div>
                  <div class="col-lg-12 col-md-8 mx-auto">
