...
<section class="dashboard_main_section" style="background-image:url(assets/images/gradiantbg.jpg);">
    ...
    <div class="row">
      <div class="col-lg-10 col-md-12 mx-auto ">
        <div class="edit_profile_link_wraper mb-lg-4 mb-3">
          ...
          <a href="editprofile.php"><img src="assets/images/editicon.svg">Edit</a>
        </div>
      </div>
      <div class="col-lg-8 mx-auto">
        <div class="row">
          ...
          <div class="col-lg-6 col-md-6 col-sm-6">
            <div class="profile_name_box text-center mb-4">
              <div class="user_icon">
                <img src="assets/images/mailicon.svg">
              </div>
