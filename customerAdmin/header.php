    ...
    <div  id="dashboardSidebar">
      ...
      <div class="sidebar_navigation">
        <ul class="sidebar_navcigation">
          <li><a href="index.php" ><img src="assets/images/dashomeicon.svg"> <span>Home</span></a>
          </li>
          <li><a href="inbox.php"><img src="assets/images/dashinboxicon.svg"><span>Inbox</span></a></li>
          <li><a href="activequotes.php"><img src="assets/images/dashallqouticon.svg"><span>All Quotes</span></a>
          </li>
          <li><a href="wishlist.php"><img src="assets/images/dashhearticon.svg"><span>Preferred Garages</span></a>
          </li>
          <li><a href="insurancePayment.php"><img src="assets/images/dashpaymenticon.svg"><span>Payment Via Insurance</span></a>
          </li>
          <li><a href="postAd.php"><img src="assets/images/dashsellcaricon.svg"><span>Sell Your Car</span></a>
          </li>
        </ul>
      </div>
          ...
          <div class="container-lg container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              ...
              <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                  <a class="nav-link " href="requestbid1.php">Request A Quote</a>
                </li>
                <li class="nav-item">
