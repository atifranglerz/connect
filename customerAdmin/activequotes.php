        ...
        <div class="all_quote_card ">
          ...
          <div class=" w-100  quote_detail_wraper">
            <div class="quote_info">
              <h3 class="d-flex align-items-center active_quote"><a href="#">Car Repair</a> <span class="order_id">#12345678</span></h3>
            ...
            <div class="quote_detail_btn_wraper">
              ...
              <div class="d-flex align-items-center chat_view__detail">
               ...
               <a href="quoteAllReplies.php" class="btn-secondary">VIEW DETAILS</a>
             </div>
        ...
        <div class="all_quote_card ">
          ...
          <div class=" w-100  quote_detail_wraper">
            ...
            <div class="quote_detail_btn_wraper">
              <h3 class=" text-sm-center">AED 1200</h3>
              <div class="d-flex align-items-center chat_view__detail">
               <a href="#" class="chat_icon"><i class="fa-solid fa-message"></i></a>
               <a href="quoteAllReplies.php" class="btn-secondary">VIEW DETAILS</a>
             </div>
